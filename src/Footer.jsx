...
<div className=' relative w-full h-60  bg-[#030A16] flex justify-center overflow-hidden'>
  <div className='w-[50%] h-full ' >
     ...
     <div className='flex justify-center  sm:gap-12 lg:gap-36 xl:gap-44 text-xl font-semibold  md:gap-20 gap-5'>
...
<div className='w-full h-14 bg-[#000000] text-center flex items-center justify-center'>
